...
execute if score @s o-k.b_ksig matches 0 if score @s o-k.b_octv matches 0 run function origins-kombo-bard:notes/octave_1/gs

execute if score @s o-k.b_ksig matches 0 if score @s o-k.b_octv matches 1 run function origins-kombo-bard:notes/octave_2/gs
