...
execute if score @s o-k-b.ksig matches 12 if score @s o-k-b.octv matches 1 run function origins-kombo-bard:notes/1st_octave/cs

execute if score @s o-k-b.ksig matches 12 if score @s o-k-b.octv matches 2 run function origins-kombo-bard:notes/2nd_octave/cs