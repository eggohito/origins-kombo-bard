#> origins-kombo:key/hotbar.5
#
#   > The hotbar.5 button
#
#   - Referenced in the **`origins-kombo:key\hotbar.5`** power
#
#     (`data\origins-kombo\powers\key\hotbar.5.json`)
#
#@private
...
#
#   - For this key, we'll be appending the "key.hotbar.5" string into the storage
#
function rx.playerdb:api/get_self

data modify storage rx:io playerdb.player.data.origins-kombo.input append value "key.hotbar.5"
...
#
function #origins-kombo:key/hotbar.5