#> origins-kombo:key/hotbar.2
#
#   > The hotbar.2 button
#
#   - Referenced in the **`origins-kombo:key\hotbar.2`** power
#
#     (`data\origins-kombo\powers\key\hotbar.2.json`)
#
#@private
...
#
#   - For this key, we'll be appending the "key.hotbar.2" string into the storage
#
function rx.playerdb:api/get_self

data modify storage rx:io playerdb.player.data.origins-kombo.input append value "key.hotbar.2"
...
#
function #origins-kombo:key/hotbar.2