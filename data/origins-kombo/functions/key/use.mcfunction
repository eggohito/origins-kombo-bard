...
#   > The use button
#
#   - Referenced in the **`origins-kombo:key\use`** power
#
#     (`data\origins-kombo\powers\key\use.json`)
#
#@private
...
data modify storage rx:io playerdb.player.data.origins-kombo.input append value "key.use"
