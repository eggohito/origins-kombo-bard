#> origins-kombo:key/hotbar.4
#
#   > The hotbar.4 button
#
#   - Referenced in the **`origins-kombo:key\hotbar.4`** power
#
#     (`data\origins-kombo\powers\key\hotbar.4.json`)
#
#@private
...
#
#   - For this key, we'll be appending the "key.hotbar.4" string into the storage
#
function rx.playerdb:api/get_self

data modify storage rx:io playerdb.player.data.origins-kombo.input append value "key.hotbar.4"
...
#
function #origins-kombo:key/hotbar.4