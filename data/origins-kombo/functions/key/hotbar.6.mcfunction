...
#
#     (`data\origins-kombo\powers\key\hotbar.6.json`)
#
#@private
...
data modify storage rx:io playerdb.player.data.origins-kombo.input append value "key.hotbar.6"
...
#
function #origins-kombo:key/hotbar.6