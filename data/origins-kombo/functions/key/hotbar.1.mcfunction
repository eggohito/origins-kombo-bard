#> origins-kombo:key/hotbar.1
#
#   > The hotbar.1 button
#
#   - Referenced in the **`origins-kombo:key\hotbar.1`** power
#
#     (`data\origins-kombo\powers\key\hotbar.1.json`)
#
#@private
...
#
#   - For this key, we'll be appending the "key.hotbar.1" string into the storage
#
function rx.playerdb:api/get_self

data modify storage rx:io playerdb.player.data.origins-kombo.input append value "key.hotbar.1"
...
#
function #origins-kombo:key/hotbar.1